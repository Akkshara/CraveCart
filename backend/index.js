...
app.post('/signin', async (req, res) => {
  ...
  try {
    ...
    res.redirect('http://localhost:3000/'); // Adjust this to match your front-end route
  } catch (error) {
...
app.post('/predict', (req, res) => {
  ...
  const { nitrogen, phosporus, potassium, temperature, humidity, pH } = formData;

  // Run your model and get recommendation
  const recommendation = runModel(nitrogen, phosporus, potassium, temperature, humidity, pH);
